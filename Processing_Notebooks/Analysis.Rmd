...
print(p)
ggsave(filename = "../PBTK-Modelling-PFAS/plots/Feces_conc_28d.png", plot = p, width = 5, height = 5, dpi = 300,bg = "white")
...
print(p)
ggsave(filename = "../PBTK-Modelling-PFAS/plots/feces_56_conc.png", plot = p, width = 12.5, height = 5, dpi = 300,bg = "white")
...
print(p)
ggsave(filename = "../PBTK-Modelling-PFAS/plots/fecesxliver_pfos.png", plot = p, width = 7, height = 6, dpi = 300,bg = "white")
...
print(p)
ggsave(filename = "../PBTK-Modelling-PFAS/plots/fecesxliver_pfoa.png", plot = p, width = 7, height = 6, dpi = 300,bg = "white")
...
print(p)
ggsave(filename = "../PBTK-Modelling-PFAS/plots/fecesxplasma_pfos.png", plot = p, width = 7, height = 6, dpi = 300,bg = "white")
...
print(p)
ggsave(filename = "../PBTK-Modelling-PFAS/plots/fecesxplasma_pfoa.png", plot = p, width = 7, height = 6, dpi = 300,bg = "white")
...
predictions <- map_df(dose_vec, function(dose) {
  ...
  map_df(c("Male", "Female"), function(sex) {
    ...
    if (sex == "Male") {
      pars$Vdist <- 0.263
      pars$kelim <- 0.0007290
    } else {
      pars$Vdist <- 0.261
      pars$kelim <- 0.0008463
    }
    pars$Funbound.plasma <- 0.00256
...
```{r}
#convert to ml/day/kg
clearance_pred_m <- 0.0002402 * 24* 1000
clearance_pred_f <- 0.0003341 * 24* 1000
clearance <- mean(c(clearance_pred_f, clearance_pred_m), na.rm = TRUE)
